...
Pull requests automatically deploy to the [Bloodpoint Farming Embed Test](https://discord.gg/5PSfCFb8Th) server. You can push changes to your PR branch and verify them in the server.
